...
# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  todo: make it uncomment after testcases
STATIC_URL = 'static/'
...
# EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend" this will be used to receive o/p in console
